    ...
    return vol.Schema(
        {
            ...
            vol.Optional(CONF_IPINFO_TOKEN, default=defaults.get(CONF_IPINFO_TOKEN, DEFAULT_IPINFO_TOKEN)): str,
            vol.Optional(CONF_VIRUSTOTAL_API_KEY, default=defaults.get(CONF_VIRUSTOTAL_API_KEY, DEFAULT_VIRUSTOTAL_API_KEY)): str,
            vol.Optional(CONF_SHODAN_API_KEY, default=defaults.get(CONF_SHODAN_API_KEY, DEFAULT_SHODAN_API_KEY)): str,
            ...
            vol.Optional(CONF_IPINFO_DAILY_BUDGET, default=defaults.get(CONF_IPINFO_DAILY_BUDGET, DEFAULT_IPINFO_DAILY_BUDGET)): int,
            ...
            vol.Optional(CONF_SHODAN_DAILY_BUDGET, default=defaults.get(CONF_SHODAN_DAILY_BUDGET, DEFAULT_SHODAN_DAILY_BUDGET)): int,
        ...
        schema = _build_schema(
            {
                ...
                CONF_IPINFO_TOKEN: get_entry_value(self.config_entry, CONF_IPINFO_TOKEN, DEFAULT_IPINFO_TOKEN),
                CONF_VIRUSTOTAL_API_KEY: get_entry_value(self.config_entry, CONF_VIRUSTOTAL_API_KEY, DEFAULT_VIRUSTOTAL_API_KEY),
                CONF_SHODAN_API_KEY: get_entry_value(self.config_entry, CONF_SHODAN_API_KEY, DEFAULT_SHODAN_API_KEY),
                ...
                CONF_IPINFO_DAILY_BUDGET: get_entry_value(self.config_entry, CONF_IPINFO_DAILY_BUDGET, DEFAULT_IPINFO_DAILY_BUDGET),
                ...
                CONF_SHODAN_DAILY_BUDGET: get_entry_value(self.config_entry, CONF_SHODAN_DAILY_BUDGET, DEFAULT_SHODAN_DAILY_BUDGET),
