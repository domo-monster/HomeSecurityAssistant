    ...
    return vol.Schema(
        {
            ...
            vol.Optional(CONF_VT_ABUSEIPDB_THRESHOLD, default=defaults.get(CONF_VT_ABUSEIPDB_THRESHOLD, DEFAULT_VT_ABUSEIPDB_THRESHOLD)): vol.All(int, vol.Range(min=0, max=100)),
